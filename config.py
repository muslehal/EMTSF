...
_C.DATA.DATA_PATH = ''
#_C.DATA.DATA_PATH = r'C:\Users\ENG-LT-SL-01\Downloads\LOC_sample_submission\LOC_sample_submission.csv'

# Dataset name
_C.DATA.DATASET = 'imagenet' # r'LOC_sample_submission.csv' #'imagenet' #'LOC_sample_submission.csv'
# Input image size
...
##_C.MODEL.SWINV2.DEPTHS = [  2,6, 2]
#_C.MODEL.SWINV2.NUM_HEADS = [3, 6, 12, 24]
##_C.MODEL.SWINV2.NUM_HEADS = [ 3, 48, 96]
...
#_C.MODEL.SWIN_MOE.NUM_LOCAL_EXPERTS = 8
#_C.MODEL.SWIN_MOE.TOP_VALUE = 1
#_C.MODEL.SWIN_MOE.CAPACITY_FACTOR = 1.25
#_C.MODEL.SWIN_MOE.COSINE_ROUTER = False #False
#_C.MODEL.SWIN_MOE.NORMALIZE_GATE = False #False
...
#def _update_config_from_file(config,args):#, cfg_file
#    config.defrost()
#    #with open( 'r') as f:
#    #    yaml_cfg = yaml.load(f, Loader=yaml.FullLoader)
...
#    #    if cfg:
#            #_update_config_from_file(
#            #    config, os.path.join(os.path.dirname( cfg)
#            #)
#    #print('=> merge config from {}'.format(cfg_file))
#    #config.merge_from_file(cfg_file)
#    config.freeze()
