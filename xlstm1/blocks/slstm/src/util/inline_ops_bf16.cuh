...
// ADD
template <>
__device__ __forceinline__ __nv_bfloat16 add_g(const __nv_bfloat16 a, const __nv_bfloat16 b) {
  return __hadd(a, b);
}

// SUB
template <>
__device__ __forceinline__ __nv_bfloat16 sub_g(const __nv_bfloat16 a, const __nv_bfloat16 b) {
  return __hsub(a, b);
}

// MUL
template <>
__device__ __forceinline__ __nv_bfloat16 mul_g(const __nv_bfloat16 a, const __nv_bfloat16 b) {
  return __hmul(a, b);
}

// DIV remains the same
template <>
__device__ __forceinline__ __nv_bfloat16 div_g(const __nv_bfloat16 a, const __nv_bfloat16 b) {
  return __hdiv(a, b);
}
